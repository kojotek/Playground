...
namespace Xft
{
    ...
    public class VertexPool
    {
        ...
        public void LateUpdate(Transform Relative)
        {
            if (VertCountChanged)
            {
                MyMesh.Clear();
            ...
            if (_owner.UseWith2D) {
                ...
                Graphics.DrawMesh(MyMesh, Matrix4x4.TRS(Relative.transform.position, Relative.rotation, Vector3.one), _material, _owner.gameObject.layer, null, 0, null, false, false);
               //Graphics.DrawMesh(MyMesh, Relative.localToWorldMatrix, _material, _owner.gameObject.layer, null, 0, null, false, false);
