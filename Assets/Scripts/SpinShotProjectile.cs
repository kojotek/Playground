...
public class SpinShotProjectile : WeaponProjectile
{

    public SpinShotProjectile(WeaponController weapon, Vector3 position, Ray ray, DamageTable table) : base(weapon, position, ray, table) { }
    ...
    public override void OnHitTarget(HitBoxController hitBox)
    {
        ...
        AttackResult result = new AttackResult(hitBox.damageReceiver.actor, damageTable, hitBox.CriticalSpot, AttackType.SpinShot);
